...
train_dataset = BrainSphere(fold1, fold4, fold5, fold2)
...
#    m_mae_t, m_mre_t  = val_during_training(train_dataloader)
#    print("Train: m_mae_s, m_mre_s, m_mae_t, m_mre_t : {:.4} {:.4}".format(m_mae_t, m_mre_t))
##    writer.add_scalars('data/mean', {'train': m_mae}, epoch)
#    m_mae_t, m_mre_t = val_during_training(val_dataloader)
#    print("Val:  m_mae_s, m_mre_s, m_mae_t, m_mre_t: {:.4} {:.4}".format( m_mae_t, m_mre_t))    
