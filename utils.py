...
def Get_upconv_index():
    ...
    upconv_top_index_10242, upconv_down_index_10242 = get_upconv_index('neigh_indices/adj_mat.mat',
                                                                       'neigh_indices/adj_order.mat')
    upconv_top_index_2562, upconv_down_index_2562 = get_upconv_index('neigh_indices/adj_mat_2562.mat',
                                                                     'neigh_indices/adj_order_2562.mat')
    upconv_top_index_642, upconv_down_index_642 = get_upconv_index('neigh_indices/adj_mat_642.mat',
                                                                   'neigh_indices/adj_order_642.mat')
    upconv_top_index_162, upconv_down_index_162 = get_upconv_index('neigh_indices/adj_mat_162.mat',
...
#    mat_path = 'neigh_indices/adj_mat.mat'
#    order_path = 'neigh_indices/adj_order.mat'
