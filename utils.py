...
def Get_indices_order():
    neigh_indices_10242 = get_indices_order('/media/zfq/WinE/unc/zhengwang/dataset/format_dataset/rec_neigh_indices_10242.mat')
    neigh_indices_2562 = get_indices_order('/media/zfq/WinE/unc/zhengwang/dataset/format_dataset/rec_neigh_indices_2562.mat')
    neigh_indices_642 = get_indices_order('/media/zfq/WinE/unc/zhengwang/dataset/format_dataset/rec_neigh_indices_642.mat')
    neigh_indices_162 = get_indices_order('/media/zfq/WinE/unc/zhengwang/dataset/format_dataset/rec_neigh_indices_162.mat')
    neigh_indices_42 = get_indices_order('/media/zfq/WinE/unc/zhengwang/dataset/format_dataset/rec_neigh_indices_42.mat')
...
def compute_weight():
    folder = '/media/zfq/WinE/unc/zhengwang/dataset/format_dataset/90/raw'
